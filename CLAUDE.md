...
## Quy tắc sau khi hoàn thành tính năng

Sau khi hoàn thành một tính năng mới hoặc sửa bug quan trọng → **luôn gọi skill `/push`** để hỏi user có muốn đẩy lên git không. Không cần user nhắc.
